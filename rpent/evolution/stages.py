        ...
        *,
        ...
        def run_attempt(
            *, resume_thread_id: str | None, reconstruct: bool
            ...
            previous_frozen = os.environ.get("RPENT_EPISODE_MEMORY_FROZEN")
            ...
            try:
                ...
                if previous_frozen is None:
                    os.environ.pop("RPENT_EPISODE_MEMORY_FROZEN", None)
                else:
                    os.environ["RPENT_EPISODE_MEMORY_FROZEN"] = previous_frozen
                toolkit.close()
