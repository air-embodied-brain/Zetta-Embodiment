...
BROKER_URL_ENV = "RPENT_API_PROVIDER_BROKER_URL"
BROKER_API_KEY_ENV = "RPENT_API_PROVIDER_BROKER_API_KEY"
BROKER_MAX_CONCURRENCY_ENV = "RPENT_API_PROVIDER_BROKER_MAX_CONCURRENCY"
BROKER_QUEUE_CAPACITY_ENV = "RPENT_API_PROVIDER_BROKER_QUEUE_CAPACITY"
    ...
    def start(self) -> str:
        ...
        self._workers = [
            threading.Thread(
                ...
                name=f"rpent-provider-dispatch-{index}",
                daemon=True,
            )
        ...
        self._thread = threading.Thread(
            ...
            name="rpent-provider-pool-proxy",
            daemon=True,
        )
        self._thread.start()
