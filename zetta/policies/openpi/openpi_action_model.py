...
from zetta.policies.openpi._compat.base_policy import BasePolicy, ForwardType
from zetta.policies.openpi._compat.explore_noise_net import ExploreNoiseNet
from zetta.policies.openpi._compat.logging import get_logger
from zetta.policies.openpi._compat.nested_dict_process import copy_dict_tensor
from zetta.policies.openpi._compat.pytree import register_pytree_dataclasses
from zetta.policies.openpi._compat.value_head import ValueHead
from zetta.policies.openpi.rtc_guidance import (
    RTCGuidanceContext,
)
from zetta.policies.openpi.rtc_guidance import (
...
class OpenPi0ForRLActionPrediction(PI0Pytorch, BasePolicy):
    ...
    def __init__(
        ...
        if self.config.use_rlt:
            from zetta.policies.openpi._compat.rlt_token_transformer import (
                RLTTokenTransformer,
            )
        ...
        if self.config.use_dsrl:
            from zetta.policies.openpi._compat.compact_encoders import (
                CompactMultiQHead,
                CompactStateEncoder,
                LightweightImageEncoder64,
            )
            from zetta.policies.openpi._compat.gaussian_policy import GaussianPolicy
