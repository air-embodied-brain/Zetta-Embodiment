...
try:
    ...
    BaseEnv = Any
    Array = Any
    common = gym_utils = None

    def _mani_skill_missing(*_args, **_kwargs):
        raise ImportError("mani-skill is required to construct ManiskillEnv")

    torch_clone_dict = put_info_on_image = tile_images = _mani_skill_missing
