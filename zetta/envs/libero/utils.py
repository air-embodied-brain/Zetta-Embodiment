...
def get_logger():
    return logging.getLogger("zetta.envs.libero")
...
def _ensure_benchmark_imported():
    ...
    preferred = {
        "pro": "liberopro.liberopro.benchmark",
        "plus": "liberoplus.liberoplus.benchmark",
        "standard": "libero.libero.benchmark",
    }.get(libero_type, "libero.libero.benchmark")
    candidates = (
        preferred,
        "libero.libero.benchmark",
        "liberopro.liberopro.benchmark",
...
def get_benchmark_overridden(benchmark_name) -> Benchmark:
    ...
    """
    global Benchmark
    benchmark = _ensure_benchmark_imported()
